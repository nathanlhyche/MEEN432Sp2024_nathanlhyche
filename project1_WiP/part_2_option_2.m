...
% Simulate combined system for Option 2 with constant step inputs
k = 1000; 
[time_combined, angular_velocity_combined] = combinedSystemOption2(@inertia, @rotationalDamper, @inertia, @rotationalDamper, k, 0, 0, A_constant_torque_S1, A_constant_torque_S2, J1, b1, b2, A_constant_torque_S1, A_constant_torque_S2, w_frequency, 0.1, [0, 10]);

% Plot results
figure;
plot(time_combined, angular_velocity_combined);
title('Option 2 - Combined Inertia and Damping');
xlabel('Time (s)');
...
function [time, angular_velocity_combined] = combinedSystemOption2(inertia_func_S1, damper_func_S1, inertia_func_S2, damper_func_S2, stiffness_k, initial_angular_velocity_S1, initial_angular_velocity_S2, initial_input_torque_S1, initial_input_torque_S2, J1, b_S1, b_S2, A_constant_torque_S1, A_constant_torque_S2, w_frequency, dt, t_span)
    ...
    for i = 2:length(time)
        ...
        torque_combined = input_torque_S1 + input_torque_S2;
